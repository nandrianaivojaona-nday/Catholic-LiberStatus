...
// --- ICONS ---
// FIX: Update icon components to accept className prop to resolve IntrinsicAttributes error.
const ArrowRightIcon = ({ className = "" }: { className?: string }) => <svg xmlns="http://www.w3.org/2000/svg" className={`h-4 w-4 ${className}`} fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" /></svg>;
const ArrowDownIcon = ({ className = "" }: { className?: string }) => <svg xmlns="http://www.w3.org/2000/svg" className={`h-4 w-4 ${className}`} fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" /></svg>;
const BuildingIcon = ({ className = "" }: { className?: string }) => <svg xmlns="http://www.w3.org/2000/svg" className={`h-5 w-5 mr-2 text-gray-500 ${className}`} viewBox="0 0 20 20" fill="currentColor"><path fillRule="evenodd" d="M10 2a1 1 0 00-1 1v1a1 1 0 002 0V3a1 1 0 00-1-1zM4 4h3a1 1 0 011 1v1H3V5a1 1 0 011-1zm6 0h3a1 1 0 011 1v1h-4V5a1 1 0 011-1zM4 9h12v7a1 1 0 01-1 1H5a1 1 0 01-1-1V9zm2-4h6v1H6V5z" clipRule="evenodd" /></svg>;
const UsersIcon = ({ className = "" }: { className?: string }) => <svg xmlns="http://www.w3.org/2000/svg" className={`h-5 w-5 mr-2 text-gray-500 ${className}`} viewBox="0 0 20 20" fill="currentColor"><path d="M9 6a3 3 0 11-6 0 3 3 0 016 0zm-1.5 5.5a3 3 0 00-3 0V12a2 2 0 002 2h2a2 2 0 002-2v-.5a3 3 0 00-3 0zM17 6a3 3 0 11-6 0 3 3 0 016 0zm-1.5 5.5a3 3 0 00-3 0V12a2 2 0 002 2h2a2 2 0 002-2v-.5a3 3 0 00-3 0z" /></svg>;
const UserIcon = ({ className = "" }: { className?: string }) => <svg xmlns="http://www.w3.org/2000/svg" className={`h-5 w-5 mr-2 text-gray-500 ${className}`} viewBox="0 0 20 20" fill="currentColor"><path fillRule="evenodd" d="M10 9a3 3 0 100-6 3 3 0 000 6zm-7 9a7 7 0 1114 0H3z" clipRule="evenodd" /></svg>;
const GlobeIcon = ({ className = "" }: { className?: string }) => <svg xmlns="http://www.w3.org/2000/svg" className={`h-5 w-5 mr-2 text-gray-500 ${className}`} viewBox="0 0 20 20" fill="currentColor"><path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zM4.332 8.027a6.012 6.012 0 011.912-2.706C6.512 5.73 6.974 6 7.5 6A1.5 1.5 0 019 7.5V8a2 2 0 004 0 2 2 0 011.527 1.903 6.002 6.002 0 01-.85 3.055l-.42.723a1 1 0 01-1.664 0l-.42-.723a6.002 6.002 0 01-2.831-5.749A2 2 0 0010 8a2 2 0 01-1.527-1.903z" clipRule="evenodd" /></svg>;
const LockIcon = ({ className = "" }: { className?: string }) => <svg xmlns="http://www.w3.org/2000/svg" className={`h-4 w-4 ml-2 text-yellow-500 ${className}`} viewBox="0 0 20 20" fill="currentColor"><path fillRule="evenodd" d="M5 9V7a5 5 0 0110 0v2a2 2 0 012 2v5a2 2 0 01-2 2H5a2 2 0 01-2-2v-5a2 2 0 012-2zm8-2v2H7V7a3 3 0 016 0z" clipRule="evenodd" /></svg>;
const EditIcon = ({ className = "" }: { className?: string }) => <svg xmlns="http://www.w3.org/2000/svg" className={`h-5 w-5 ${className}`} viewBox="0 0 20 20" fill="currentColor"><path d="M13.586 3.586a2 2 0 112.828 2.828l-.793.793-2.828-2.828.793-.793zM11.379 5.793L3 14.172V17h2.828l8.38-8.379-2.83-2.828z" /></svg>;
const TrashIcon = ({ className = "" }: { className?: string }) => <svg xmlns="http://www.w3.org/2000/svg" className={`h-5 w-5 mr-1 ${className}`} viewBox="0 0 20 20" fill="currentColor"><path fillRule="evenodd" d="M9 2a1 1 0 00-.894.553L7.382 4H4a1 1 0 000 2v10a2 2 0 002 2h8a2 2 0 002-2V6a1 1 0 100-2h-3.382l-.724-1.447A1 1 0 0011 2H9zM7 8a1 1 0 012 0v6a1 1 0 11-2 0V8zm5-1a1 1 0 00-1 1v6a1 1 0 102 0V8a1 1 0 00-1-1z" clipRule="evenodd" /></svg>;
const PlusIcon = ({ className = "" }: { className?: string }) => <svg xmlns="http://www.w3.org/2000/svg" className={`h-5 w-5 mr-1 ${className}`} viewBox="0 0 20 20" fill="currentColor"><path fillRule="evenodd" d="M10 3a1 1 0 011 1v5h5a1 1 0 110 2h-5v5a1 1 0 11-2 0v-5H4a1 1 0 110-2h5V4a1 1 0 011-1z" clipRule="evenodd" /></svg>;
...
const TerritoryNode = React.memo((
    ...
    // Check if the content of this node (i.e., its children) can be viewed.
    // This permission is primarily for APVs to restrict access to family lists.
    const canViewNodeContent = node.type === 'APV' ? hasPermission(currentUser, 'viewFamilies', { target: node }) : true;
    const isProtected = !canViewNodeContent;

    const handleToggle = useCallback((e: React.MouseEvent) => {
        e.stopPropagation();
        // Prevent expanding a protected node, but allow collapsing if it was somehow expanded.
        if (isProtected && !isExpanded) {
            return; 
        }
        onToggle(node.id);
    }, [onToggle, node.id, isProtected, isExpanded]);
    ...
    return (
        <div style={{ paddingLeft: `${level * 20}px` }}>
            <div className={`flex items-center my-1 rounded-lg transition-colors duration-200 ${isSelected ? 'bg-vatican-gold/30 dark:bg-vatican-gold/40' : 'hover:bg-gray-100 dark:hover:bg-gray-700'} ${isProtected ? 'opacity-60' : ''}`}>
                <div className="w-6 h-8 flex items-center justify-center flex-shrink-0">
                    {hasChildren && (
                        <button 
                            onClick={handleToggle} 
                            className={`p-1 rounded-full text-gray-500 hover:text-gray-800 dark:hover:text-white focus:outline-none focus:ring-1 focus:ring-vatican-gold ${isProtected && !isExpanded ? 'cursor-not-allowed' : ''}`}
                        >
            ...
            {isExpanded && hasChildren && !isProtected && (
...
const ExecTeamDisplay: React.FC<{ team?: ExecTeam, users: User[], title: string, onEdit?: () => void, canEdit?: boolean }> = ({ team, users, title, onEdit, canEdit }) => {
    if (!team || Object.values(team).every(v => !v)) {
        return (
            <div className="mt-2 p-3 bg-gray-100 dark:bg-gray-700/50 rounded-lg">
                <div className="flex justify-between items-center">
                    ...
                    {onEdit && canEdit && (
                        <button onClick={onEdit} className="text-sm px-3 py-1 bg-blue-100 text-blue-800 rounded-md hover:bg-blue-200 flex items-center gap-1">
                            <EditIcon className="h-4 w-4" /> Assign
                        </button>
                    )}
                </div>
    ...
    // appData is not available here, so need to pass it or change logic. For now, assume users have display names.
    const { appData } = useData();

    const teamMembers = Object.entries(team).map(([role, userId]) => {
        if (!userId) return null;
        const user = users.find(u => u.id === userId);
        const believer = appData.believers.find(b => b.id === user?.believerId);
        return { role, name: believer ? `${believer.firstName} ${believer.lastName}` : (user ? user.username : 'Unassigned') };
    }).filter(Boolean);

    return (
        <div className="mt-2 p-3 bg-gray-100 dark:bg-gray-700/50 rounded-lg">
            <div className="flex justify-between items-center mb-2">
                 <h6 className="font-semibold text-md text-gray-700 dark:text-gray-300">{title}</h6>
                 {onEdit && canEdit && (
                    <button onClick={onEdit} className="text-sm px-3 py-1 bg-vatican-gold/80 text-black rounded-md hover:bg-vatican-gold flex items-center gap-1">
                        <EditIcon className="h-4 w-4" /> Edit Team
                    </button>
                 )}
            </div>
    ...
    return (
        <div className="border border-gray-200 dark:border-gray-600 rounded-lg">
            <button onClick={onToggle} className="w-full text-left p-3 flex justify-between items-center bg-gray-50 dark:bg-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600">
                <span className="font-bold text-swiss-guard-blue dark:text-vatican-gold">{group.name}</span>
...
export default function LiberstatusPage() {
    ...
    const parishUsers = useMemo(() => {
        if (!initialParishData?.id) return [];
        // Include all users for now, as leaders can be from outside the immediate parish roster in some cases (e.g. admins)
    ...
    const handleSaveBeliever = (formData: any) => {
        if (formData.id) { // Editing existing believer
            updateBeliever(formData as Believer);
        } else { // Adding new believer (potentially with new family)
            addBeliever(formData); 
        }
        handleCloseBelieverModal();
    };
    ...
    const handleEditTerritory = () => {
        if (selectedNode && parentNode) {
            ...
            let initialData = { ...selectedNode };
            
            // Convert user IDs in execTeam to believer IDs for the form
            if (initialData.execTeam) {
                const believerExecTeam: ExecTeam = {};
                for (const [role, userId] of Object.entries(initialData.execTeam)) {
                    const user = appData.users.find(u => u.id === userId);
                    if (user?.believerId) {
                        (believerExecTeam as any)[role] = user.believerId;
                    }
                }
                initialData.execTeam = believerExecTeam;
            }

            if (parentNode.type === 'ZONE') { // Editing an APV
                eligible = StatisticsService.getBelieversInTerritory(parentNode, appData);
            } else if (parentNode.type === 'PARISH') { // Editing a Zone
                eligible = parishBelievers;
            }
            
            setEligibleBelieversForModal(eligible);
            setTerritoryModalConfig({ mode: 'edit', data: initialData });
            setTerritoryModalOpen(true);

        } else if (selectedNode?.type === 'PARISH') {
            setEligibleBelieversForModal(parishBelievers);
    ...
    return (
        <section className="space-y-8">
                    ...
                    {!selectedNode ? <div className="text-center text-gray-500 dark:text-gray-400 p-8 border-2 border-dashed rounded-lg"><p>{t('liberstatus.management.selectInstruction')}</p></div> : (
                        <div className="space-y-6">
                            ...
                            <div className="border-t dark:border-gray-600 pt-4"><h5 className="font-bold text-lg mb-2">Actions</h5><div className="flex flex-wrap gap-2">
                                {selectedNode.type === 'PARISH' && (<><button onClick={handleAddZone} disabled={!canAddZone} className="px-4 py-2 bg-swiss-guard-blue text-white rounded-md hover:bg-blue-800 disabled:bg-gray-400 disabled:cursor-not-allowed flex items-center" title={getButtonTitle(!canAddZone, t('liberstatus.management.addZoneTitle'), t('liberstatus.management.addZoneDisabled'))}><PlusIcon/>{t('liberstatus.management.addZone')}</button><button onClick={handleOpenParishModal} disabled={!canEditParishDetails} className="px-4 py-2 bg-vatican-gold text-swiss-guard-blue rounded-md hover:bg-yellow-400 disabled:bg-gray-400 disabled:cursor-not-allowed flex items-center"><EditIcon className="mr-1"/> Modify Parish</button></>)}
                                {selectedNode.type === 'ZONE' && (<><button onClick={handleAddAPV} disabled={!canAddAPV} className="px-4 py-2 bg-swiss-guard-blue text-white rounded-md hover:bg-blue-800 disabled:bg-gray-400 disabled:cursor-not-allowed flex items-center" title={getButtonTitle(!canAddAPV, t('liberstatus.management.addAPVTitle'), t('liberstatus.management.addAPVDisabled'))}><PlusIcon/>{t('liberstatus.management.addAPV')}</button><button onClick={handleEditTerritory} disabled={!canEditTerritory} className="px-4 py-2 bg-vatican-gold text-black rounded-md hover:bg-yellow-400 disabled:bg-gray-400 disabled:cursor-not-allowed flex items-center"><EditIcon className="mr-1"/> Edit Zone</button><button onClick={handleDeleteTerritory} disabled={!canDeleteTerritory} className="px-4 py-2 bg-papal-red text-white rounded-md hover:bg-red-700 disabled:bg-gray-400 disabled:cursor-not-allowed flex items-center"><TrashIcon/> Delete Zone</button></>)}
                                {selectedNode.type === 'APV' && (<><button onClick={handleAddHousehold} disabled={!canAddHousehold} className="px-4 py-2 bg-swiss-guard-blue text-white rounded-md disabled:bg-gray-400 disabled:cursor-not-allowed hover:bg-blue-800 flex items-center" title={getButtonTitle(!canAddHousehold, t('liberstatus.management.addHousehold'), t('liberstatus.management.addHouseholdDisabled'))}><PlusIcon/>{t('liberstatus.management.addHousehold')}</button><button onClick={handleEditTerritory} disabled={!canEditTerritory} className="px-4 py-2 bg-vatican-gold text-black rounded-md hover:bg-yellow-400 disabled:bg-gray-400 disabled:cursor-not-allowed flex items-center"><EditIcon className="mr-1"/> Edit APV</button><button onClick={handleDeleteTerritory} disabled={!canDeleteTerritory} className="px-4 py-2 bg-papal-red text-white rounded-md hover:bg-red-700 disabled:bg-gray-400 disabled:cursor-not-allowed flex items-center"><TrashIcon/> Delete APV</button></>)}
                                {selectedNode.type === 'FAMILY' && (<><button onClick={handleModifyFamily} disabled={!canEditFamily} className="px-4 py-2 bg-vatican-gold text-black rounded-md disabled:bg-gray-400 disabled:cursor-not-allowed hover:bg-yellow-400 flex items-center" title={getButtonTitle(!canEditFamily, t('liberstatus.management.modifyFamily'), t('liberstatus.management.modifyFamilyDisabled'))}><EditIcon className="mr-1"/> {t('liberstatus.management.modifyFamily')}</button><button onClick={handleDeleteFamily} disabled={!canDeleteFamily} className="px-4 py-2 bg-papal-red text-white rounded-md hover:bg-red-700 disabled:bg-gray-400 disabled:cursor-not-allowed flex items-center"><TrashIcon/> Delete Family</button><button onClick={handleOpenAddMemberForm} disabled={!canManageBelievers} className="px-4 py-2 bg-swiss-guard-blue text-white rounded-md hover:bg-blue-800 disabled:bg-gray-400 disabled:cursor-not-allowed flex items-center"><PlusIcon /> Add Member</button></>)}
                            </div></div>
                            {selectedNode.type === 'FAMILY' && selectedNode.members && (<div className="border-t dark:border-gray-600 pt-4 mt-4"><h5 className="font-semibold text-lg mb-2">Members</h5><ul className="space-y-2">{selectedNode.members.map(member => (<li key={member.id} className="flex items-center justify-between p-2 bg-gray-50 dark:bg-gray-700 rounded-md"><div><span className="font-medium">{member.fullName}</span><span className="text-sm text-gray-500 dark:text-gray-400 ml-2">({member.relationshipToHead})</span></div><div className="space-x-2">{hasPermission(currentUser, 'EDIT_BELIEVER_SELF', { believer: member }) && (<button onClick={() => handleOpenEditBeliever(member)} className="text-sm px-3 py-1 bg-blue-100 text-blue-800 rounded-md hover:bg-blue-200 flex items-center gap-1"><EditIcon className="h-4 w-4 mr-1"/> My Info</button>)}{canManageBelievers && !hasPermission(currentUser, 'EDIT_BELIEVER_SELF', { believer: member }) && (<button onClick={() => handleOpenEditBeliever(member)} className="text-sm px-3 py-1 bg-gray-200 text-gray-800 rounded-md hover:bg-gray-300 flex items-center gap-1"><EditIcon className="h-4 w-4 mr-1"/> Edit Member</button>)}</div></li>))}</ul></div>)}
            ...
            {editingBeliever && (<AdminModal title={editingBeliever.id ? `Edit ${editingBeliever.firstName} ${editingBeliever.lastName}` : "Add New Member"} isOpen={!!editingBeliever} onClose={handleCloseBelieverModal}><BelieverForm believer={editingBeliever as Believer} parish={initialParishData} families={appData.families} onSave={handleSaveBeliever} onCancel={handleCloseBelieverModal} /></AdminModal>)}
