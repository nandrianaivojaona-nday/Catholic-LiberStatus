...
export default function AdminConsolePage() {
    ...
    const renderTable = (data: any[]) => {
        switch (activeTab) {
            ...
            // FIX: Explicitly cast t() results to string to resolve TS error. Also convert number to string for rendering.
